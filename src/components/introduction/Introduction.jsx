...
const lanOptions = [
    {
        ...
        label: 'ENG',
        text: {
            main: "I graduated from Soongsil University (SSU) in Seoul, South Korea's capital.",
            sub: [
    ...
    },
    {
        ...
        label: 'VIE',
        text: {
            main: 'Tôi đã tốt nghiệp Đại học Soongsil (SSU) ở Seoul, thủ đô của Hàn Quốc.',
            sub: [
    ...
    },
    {
        ...
        label: 'KOR',
        text: {
            main: '저는 대한민국 서울에 위치한 숭실대학교(SSU)를 졸업했습니다.',
            sub: [
